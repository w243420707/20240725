...
# 第十步：删除 config.json 文件并根据国家下载新的配置文件
while true; do
...
# 第十二步：切换配置文件
while true; do
    wget -N --no-check-certificate "https://github.com/w243420707/20240725/raw/main/dlconfig" && chmod +x dlconfig.sh && ./dlconfig.sh
